...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \item %6
      \lstinputlisting{src/prob6.gram}
    \item %7
      \includegraphics[scale=0.4]{img/prob7_1.jpg}
      
      \includegraphics[scale=0.4]{img/prob7_2.jpg}
      
      \includegraphics[scale=0.4]{img/prob7_3.jpg}
      
      \includegraphics[scale=0.4]{img/prob7_4.jpg}
      
      \includegraphics[scale=0.4]{img/prob7_5.jpg}
      
    \item %8
      \lstset{language=python}
      \lstinputlisting{src/manatee_tokens.py}
  \end{enumerate}
